...
<head>
    ...
    <title>Manage Health Tips - Fur & Friends</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="health-tips.php" class="active"><i class='bx bx-health'></i><span>Health Tips</span></a>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Hydration</td>
                    <td>Ensure your pets have access to clean, fresh water daily.</td>
                    <td class="actions">
                ...
                <tr>
                    <td>2</td>
                    <td>Exercise</td>
                    <td>Regular exercise keeps pets active and healthy.</td>
                    <td class="actions">
                        <button class="edit">Edit</button>
                        <button class="delete">Delete</button>
                    </td>
